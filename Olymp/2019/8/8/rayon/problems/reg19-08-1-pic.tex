\begin{tikzpicture}
	...
	\draw [dashed] (2, 0) -- (2, -1);
	\draw [dashed] (3, 0) -- (3, -1);
	\draw [<->] (0, -1) -- (1, -1)node[midway, below]{\scriptsize{\variants{$60\text{~км}$}{$100\text{~км}$}}};
	\draw [<->] (1, -1) -- (2, -1)node[midway, below]{\scriptsize{\variants{$60\text{~км}$}{$100\text{~км}$}}};
	\draw [<->] (2, -1) -- (3, -1)node[midway, below]{\scriptsize{\variants{$60\text{~км}$}{$100\text{~км}$}}};
